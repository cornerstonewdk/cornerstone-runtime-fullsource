...
@implementation RTPlugin
@synthesize webView, settings, viewController, commandDelegate, hasPendingOperation;


- (RTPlugin*) initWithWebView:(UIWebView*)theWebView settings:(NSDictionary*)classSettings
{
...
- (RTPlugin*) initWithWebView:(UIWebView*)theWebView
{
    ...
    if (self) {
		...
		[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleOpenURL:) name:RTPluginHandleOpenURLNotification object:nil];
		  ...
		  callerFileName:(const char*)callerFileName callerFunctionName:(const char*)callerFunctionName 
{
	...
	if (!ok) {
		...
		if (callbackId) {
			...
			RTPluginResult* pluginResult = [RTPluginResult resultWithStatus:RTCommandStatus_ERROR messageAsString:errorString];
...
- (void) dealloc
{
	...
	[[NSNotificationCenter defaultCenter] removeObserver:self name:RTPluginHandleOpenURLNotification object:nil];
	/*
...
- (NSString*) success:(RTPluginResult*)pluginResult callbackId:(NSString*)callbackId
{
...
- (NSString*) error:(RTPluginResult*)pluginResult callbackId:(NSString*)callbackId
{
