...
@implementation RTInvokedUrlCommand
...
+ (RTInvokedUrlCommand*) commandFromObject:(NSDictionary*)object
{
    RTInvokedUrlCommand* iuc = [[[RTInvokedUrlCommand alloc] init] autorelease];
