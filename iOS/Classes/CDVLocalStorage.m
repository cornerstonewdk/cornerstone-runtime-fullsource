    ...
    for (CDVBackupInfo* info in self.backupInfo)
    {
        if ([info shouldBackup])
        {
            ...
            if (error == nil) {
                ...
                result = [RTPluginResult resultWithStatus:RTCommandStatus_OK messageAsString:message];
                ...
                result = [RTPluginResult resultWithStatus:RTCommandStatus_ERROR messageAsString:message];
