...
/**
 * This class implements the audio playback and recording capabilities used by SKTRuntime.
 * It is called by the AudioHandler Runtime class.
...
public class AudioPlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {
    ...
    public void startRecording(String file) {
        ...
        case PLAY:
            ...
            this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', "+MEDIA_ERROR+", { \"code\":"+MEDIA_ERR_ABORTED+"});");
            break;
        case NONE:
    ...
    //[20120821][chisu]
    public void readyPlaying(String file){
    ...
    public void seekToPlaying(int milliseconds) {
        if (this.readyPlayer(this.audioFile)) {
            ...
            this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', " + MEDIA_POSITION + ", " + milliseconds / 1000.0f + ");");
        }
        else {
    ...
    public void pausePlaying() {
        ...
        if (this.state == STATE.MEDIA_RUNNING) {
            ...
            this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', " + MEDIA_ERROR + ", { \"code\":" + MEDIA_ERR_NONE_ACTIVE + "});");
        }
    }
    ...
    public long getCurrentPosition() {
        if ((this.state == STATE.MEDIA_RUNNING) || (this.state == STATE.MEDIA_PAUSED)) {
            ...
            this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', " + MEDIA_POSITION + ", " + curPos / 1000.0f + ");");
            return curPos;
        }
        else {
            return -1;
    ...
    public void onPrepared(MediaPlayer player) {
        ...
        this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', " + MEDIA_DURATION + "," + this.duration + ");");
    }
    ...
    public boolean onError(MediaPlayer player, int arg1, int arg2) {
        ...
        this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', { \"code\":" + arg1 + "});");
        return false;
    }
    ...
    private void setState(STATE state) {
        if (this.state != state) {
            this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', " + MEDIA_STATE + ", " + this.state.ordinal() + ");");
        }
        this.state = state;
    }
    ...
    private void setMode(MODE mode) {
        if (this.mode != mode) {
            ...
            //this.handler.sendJavascript("srt.sktrequire('srt/plugin/Media').onStatus('" + this.id + "', " + MEDIA_STATE + ", " + mode + ");");
        }
        this.mode = mode;
    }
        ...
        if (playMode()) {
            switch (this.state) {
                case MEDIA_NONE:
                    ...
                    return false;
                case MEDIA_LOADING:
                    //srt js is not aware of MEDIA_LOADING, so we send MEDIA_STARTING insntead
                ...
                case MEDIA_STOPPED:
                	...
                	//[20120913][chisu]when resume exception 
                	if(file == null)
                		return false;
