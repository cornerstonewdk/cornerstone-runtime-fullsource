...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		final Notification notification = new Notification.Builder(context).setContentTitle(notificationTitle)
		...
		//Intent backintent = new Intent(context, RuntimeStandAlone.class); 
		//final PendingIntent contentIntent = PendingIntent.getActivity(context, 0, backintent, 0);
		...
		Log.e("NOTI ID", String.valueOf(notificationId));
		/*
