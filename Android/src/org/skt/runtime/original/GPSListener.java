 ...
 *
 */
public class GPSListener extends SKTRuntimeLocationListener {
	public GPSListener(LocationManager locationManager, GeoBroker m) {
		super(locationManager, m, "[SKTRuntime GPSListener]");
	}
	...
	protected void start() {
		if (!this.running) {
			if (this.locationManager.getProvider(LocationManager.GPS_PROVIDER) != null) {
				...
				this.fail(SKTRuntimeLocationListener.POSITION_UNAVAILABLE, "GPS provider is not available.");
			}
		}
	}
}
