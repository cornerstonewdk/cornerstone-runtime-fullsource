...
/**
 * This class provides a way for Java to run JavaScript in the web page that has loaded SKTRuntime.
...
public class CallbackServer implements Runnable {
	 ...
	 * 
	 * If SKTRuntime app is loaded from file://, then we can use XHR
	 * otherwise we have to use polling due to cross-domain security restrictions.
	 * 
	 * @param url			The URL of the SKTRuntime app being loaded
	 */
