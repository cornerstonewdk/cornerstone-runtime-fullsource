package org.skt.runtime.plugin;
...
public class PagetLoadingPlugin extends Plugin {
	...
	public PluginResult execute(String action, JSONArray args, String callbackId) {
			...
			else if(action.equalsIgnoreCase("getEndPageLoadingTime")){		
				long endtime = RuntimeWebViewClient.getEndPageLoadingTime();
				PluginResult result = new PluginResult(PluginResult.Status.OK, endtime);
				this.success(result, this.callbackId);
			}
			
			else if(action.equalsIgnoreCase("getStartPageLoadingTime")){		
				long starttime = RuntimeWebViewClient.getStartPageLoadingTime();
				PluginResult result = new PluginResult(PluginResult.Status.OK, starttime);
				this.success(result, this.callbackId);
			}
