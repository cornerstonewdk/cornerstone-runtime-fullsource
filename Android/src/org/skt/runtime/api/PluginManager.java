...
/**
 * PluginManager is exposed to JavaScript in the SKTRuntime WebView.
 * 
...
public class PluginManager {
    ...
    private final RuntimeInterface ctx;
     ...
     * @param ctx
     */
    public PluginManager(WebView app, RuntimeInterface ctx) {
        this.ctx = ctx;
        this.app = app;
        this.firstRun = true;
    }
