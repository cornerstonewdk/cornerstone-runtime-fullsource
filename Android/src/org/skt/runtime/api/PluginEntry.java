...
public class PluginEntry {
    ...
    public IPlugin createPlugin(WebView webView, RuntimeInterface ctx) {
        if (this.plugin != null) {
            return this.plugin;
        }
        try {
            Class c = getClassByName(this.pluginClass);
            if (isSKTRuntimePlugin(c)) {
     ...
     * org.skt.runtime.api.Plugin interface.
     * 
     * @param c                     The class to check the interfaces of.
     * @return                      Boolean indicating if the class implements org.skt.runtime.api.Plugin
     */
    @SuppressWarnings("unchecked")
    private boolean isSKTRuntimePlugin(Class c) {
        if (c != null) {
            return org.skt.runtime.api.Plugin.class.isAssignableFrom(c) || org.skt.runtime.api.IPlugin.class.isAssignableFrom(c);
        }
        return false;
    }
}
