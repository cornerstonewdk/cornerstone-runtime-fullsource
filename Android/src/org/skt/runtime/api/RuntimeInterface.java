/*
       ...
       under the License.
*/
package org.skt.runtime.api;

import java.util.HashMap;

import org.skt.runtime.additionalapis.RuntimeNfc;
...
/**
 * The SKTRuntime activity abstract class that is extended by DroidGap.
 * It is used to isolate plugin development, and remove dependency on entire SKTRuntime library.
 */
public interface RuntimeInterface {
    ...
    /**
     * Load the specified URL in the SKTRuntime webview.
     * 
    ...
    //[20120821][chisu]to screen shot
    public abstract Window getRuntimeInterfaceWindow();
 
    //public abstract RuntimeNfc getRuntimeNfc();
}
